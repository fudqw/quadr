...
class App:
    ...
    def __init__(self, master, ser):
        ...
        ####LABELS
        #self.FL1text = "Front-left top joint "
        self.labelFL1 = tk.Label(master, 
                             text=self.FL1text, fg="red")

        self.labelFL1.grid(row=1, column=0, padx=0, pady=0, sticky="nw")
        
        self.labelFL2 = tk.Label(master, 
                             text="Front-left bottom joint", fg="red")
        self.labelFL2.grid(row=2, column=0, padx=0, pady=0, sticky="nw")

        self.labelFR1 = tk.Label(master, 
                             text="Front-right top joint", fg="red")
        self.labelFR1.grid(row=1, column=7, padx=0, pady=0, sticky="nw")
        
        self.labelFR2 = tk.Label(master, 
                             text="Front-right bottom joint", fg="red")
        self.labelFR2.grid(row=2, column=7, padx=0, pady=0, sticky="nw")
        
        #self.labelBL1 = tk.Label(master, 
        #                     text=" ", fg="red")
        #self.labelBL1.grid(row=4, column=0, padx=0, pady=0, sticky="nw")
        
        self.labelBL1 = tk.Label(master, 
                             text="Back-left top joint", fg="red")
        
        self.labelBL1.grid(row=5, column=0, padx=0, pady=0, sticky="nw")
        
        self.labelBL2 = tk.Label(master, 
                             text="Back-left bottom joint", fg="red")
        self.labelBL2.grid(row=6, column=0, padx=0, pady=0, sticky="nw")
        
        self.labelBR1 = tk.Label(master, 
                             text="Back-right top joint", fg="red")
        self.labelBR1.grid(row=5, column=7, padx=0, pady=0, sticky="nw")

        self.labelBR2 = tk.Label(master, 
                             text="Back-left bottom joint", fg="red")
        self.labelBR2.grid(row=6, column=7, padx=0, pady=0, sticky="nw")
...
####################################################
    ...
    def STEPFL(self):
        ...
        for x in range(0, 1):       
            if (walking==1):
                self.ser.write(bytearray('FL2'+self.convstr(FL2up), 'utf8'))
                time.sleep(0.5)
                self.ser.write(bytearray('FL1'+self.convstr(FL1up), 'utf8'))
                time.sleep(0.5)
                self.writeFL2_reset()
                time.sleep(0.5)
                self.writeFL1_reset()
    ...
    def STEPFR(self):
        ...
        for x in range(0, 1):       
            if (walking==1):
                self.ser.write(bytearray('FR2'+self.convstr(FR2up), 'utf8'))
                time.sleep(0.5)
                self.ser.write(bytearray('FR1'+self.convstr(FR1up), 'utf8'))
                time.sleep(0.5)
                self.writeFR2_reset()
                time.sleep(0.5)
                self.writeFR1_reset()
